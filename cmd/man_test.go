...
func TestManWritesOpaqueDocumentation(t *testing.T) {
	...
	service := fakeService{documentationFunc: func(_ context.Context, selector catalog.PackageSelector) (catalog.PackageDocumentation, error) {
...
func TestManWrapsBackendError(t *testing.T) {
	...
	service := fakeService{documentationFunc: func(context.Context, catalog.PackageSelector) (catalog.PackageDocumentation, error) {
